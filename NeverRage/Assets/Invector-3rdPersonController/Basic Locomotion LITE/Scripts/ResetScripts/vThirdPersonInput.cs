...
#region PlayerAnimatorManager
    public class vThirdPersonInput : MonoBehaviour
    {
        ...
        {
            CharacterInit(); //this runs the Init() which is run at the start of the controller, this is in the Motor
        }

        protected virtual void CharacterInit()
        {
            //this calls Init() for the controller
            cc = GetComponent<vThirdPersonController>();
            if (cc != null)
                cc.Init();

            //this finds the camera script...below it will then give the gameObject with this script as a newTarget to the cameraScript
            tpCamera = FindObjectOfType<vThirdPersonCamera>();
            if (tpCamera) tpCamera.SetMainTarget(this.transform);  //Calls to the tpCam script function 'SetMainTarget' and give it a newTarget as this

            //Cursor is turn off at the start of a scene
